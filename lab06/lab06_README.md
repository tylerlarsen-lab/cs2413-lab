...
# Question 2: Count Isolated Nodes
...
Write a function that check whether the graph contains a triangle. A triangle is a set of three nodes that are all connected to each other.
